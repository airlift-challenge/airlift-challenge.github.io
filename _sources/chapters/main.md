...
A reward signal generated by the environment penalizes late deliveries, missed deliveries, and movement.

% See "examples/exampleinterface.py" for an executable file containing the below code.
...
* **Results Announcement**: March 1st, 2024
...
* {{round1testscen}}: Test scenarios used for the Competition Phase
